...
class MyPrintArray(object):
    ...
    def __init__(self):
        ...
        #           Merged Name_for_wkst key   key_name               cond
        # Do_update Header header        found of_measure type format format db_type comment
        self.printArrayHeadings = (
            "pts",
            "do_update",
            "merged_header",
    ...
    def storePrintArray(self):
        ...
        cnt = 0
        for myprintArray in (self.printArray):
            for i, heading in enumerate(self.printArrayHeadings):
    ...
    def getHeadingsFromPrintArray(self, merged, pts_get):
        ...
        for arrayEntryPtr in myPAarray:
            ...
            merged_heading = self.getPrintArrayValueByHeading(arrayEntryPtr,
                                                              "merged_header")
            heading = self.getPrintArrayValueByHeading(arrayEntryPtr,
                                                       "wkst_header")
            pts = self.getPrintArrayValueByHeading(arrayEntryPtr, "pts")
    ...
    def getPrintArrayHashByValue(self, heading, heading_name):
